export default function LivingWithPCOS() {
  return (
    <section id="living" className="py-20 bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50 dark:from-gray-800 dark:via-purple-900/10 dark:to-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div className="space-y-8">
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
              <h3 className="text-2xl font-semibold text-pink-600 mb-4">💪 Building Resilience</h3>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
              <h3 className="text-2xl font-semibold text-purple-600 mb-4">👥 Community Support</h3>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
              <h3 className="text-2xl font-semibold text-blue-600 mb-4">🎯 Setting Goals</h3>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-pink-500 to-purple-600 text-white rounded-2xl p-8 shadow-xl transform hover:scale-105 transition-all">
